...
pub fn StatsSection() -> impl IntoView {
    view! {
        <section class="github-stats-section">
            <div class="section-header">
                <div>
                    <h3 class="section-title">"GitHub Statistics & Languages"</h3>
                    <p class="section-subtitle">"Top languages breakdown and activity metrics"</p>
                </div>
            </div>
            <div class="stats-grid">
                <div class="stats-card card">
                    <img
                        src="https://github-readme-stats.vercel.app/api?username=j-cray&show_icons=true&theme=transparent&title_color=059669&text_color=64748b&icon_color=059669&hide_border=true&locale=en"
                        alt="j-cray GitHub Stats Overview"
                        class="stats-widget-img"
                        loading="lazy"
                    />
                </div>
                <div class="stats-card card">
                    <img
                        src="https://github-readme-stats.vercel.app/api/top-langs/?username=j-cray&layout=compact&theme=transparent&title_color=059669&text_color=64748b&hide_border=true&locale=en"
                        alt="j-cray Most Used Languages"
                        class="stats-widget-img"
                        loading="lazy"
                    />
                </div>
                <div class="stats-card card stats-card-wide">
                    <img
                        src="https://github-readme-streak-stats.herokuapp.com/?user=j-cray&theme=transparent&hide_border=true&ring=059669&fire=059669&currStreakLabel=059669&sideLabels=64748b&dates=64748b"
                        alt="j-cray GitHub Streak Stats"
                        class="stats-widget-img streak-img"
                        loading="lazy"
                    />
                </div>
            </div>
