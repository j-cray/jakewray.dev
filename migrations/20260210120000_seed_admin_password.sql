...
VALUES (
    lower(hex(randomblob(4))) || '-' || lower(hex(randomblob(2))) || '-4' || substr(lower(hex(randomblob(2))),2) || '-' || lower(hex(randomblob(1) & X'3f' | X'80')) || lower(hex(randomblob(1))) || '-' || lower(hex(randomblob(6))),
