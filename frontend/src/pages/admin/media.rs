    ...
    let on_delete = move |url: String| {
        ...
        spawn_local(async move {
            ...
            match delete_media(t, decoded_path.clone()).await {
                Ok(_) => {
                    set_success_msg.set("Permanently deleted asset from GCS.".to_string());
        ...
        <div class="container py-12">
            ...
            <div class="card">
                <div class="flex justify-between items-center mb-6">
                    ...
                    <button class="btn btn-sm btn-secondary" on:click=move |_| fetch_media(false) disabled=move || loading.get()>"Refresh Grid"</button>
                </div>
                                ...
                                view! {
                                    <div class="relative group border border-gray-200 rounded-xl overflow-hidden bg-gray-50 shadow-sm hover:shadow-md hover:border-blue-300 transition-all flex flex-col">
                                        ...
                                        <div class="p-3 flex flex-col gap-2 flex-grow">
                                            <span class="text-sm font-semibold truncate text-gray-700" title=name_title>{name}</span>
